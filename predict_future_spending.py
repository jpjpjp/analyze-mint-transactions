...
df = vms.read_structured_transactions(ec.PATH_TO_SPENDING_BY_GROUP, \
    ec.PATH_TO_YOUR_TRANSACTIONS, 'Spending Group', \
...
vms.visualize_average_spending_by_group(ret_df, 'Projected Retirement Spending', colors, ec.REPORTS_PATH+report_png)
